...
class ReviewResult(BaseModel):
    is_valid: bool = Field(description="Whether the implemented file meets the task requirements and is syntactically correct.")
    feedback: str = Field(description="If not valid, detailed feedback on what needs to be fixed. Otherwise, 'Looks good'.")
