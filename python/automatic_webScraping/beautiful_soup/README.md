## General-knowledge :
   ...
   2. Instead of using pip you could use uv for faster downloads in the virtual environments.
   3. Beautiful Soup is a Python library for parsing structured data.
